...
namespace ProductivityHub.Api.Migrations
{
    ...
    [Migration("20250902052223_AddActivityScore")]
    partial class AddActivityScore
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductivityHub.Api.Models.Segment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ProductivityHub.Api.Models.SegmentUsageAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("TenantId", "SegmentId", "OccurredAt")
                        .HasDatabaseName("IX_SegmentUsageAudit_Tenant_Segment_Time");

                    b.ToTable("segment_usage_audit");
                });
            ...
            modelBuilder.Entity("ProductivityHub.Api.Models.SegmentUsageAudit", b =>
                {
                    b.HasOne("ProductivityHub.Api.Models.Segment", "Segment")
                        .WithMany()
